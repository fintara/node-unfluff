...
void function () {
  ...
  module.exports = {
    date: function (doc) {
      var cache$, cache$1, cache$2, cache$3, cache$4, cache$5, cache$6, cache$7, cache$8, cache$9, dateCandidates1, dateCandidates2, dateCandidates3, elem, patterns, recursive, value;
      dateCandidates1 = doc("meta[property='article:published_time'],     meta[itemprop*='datePublished'], meta[name='dcterms.modified'],     meta[name='dcterms.date'],     meta[name='DC.date.issued'],  meta[name='dc.date.issued'],     meta[name='dc.date.modified'], meta[name='dc.date.created'],     meta[name='DC.date'],     meta[name='DC.Date'],     meta[name='dc.date'],     meta[name='date'],     time[itemprop*='pubDate'],     time[itemprop*='pubdate'],     time");
      if (dateCandidates1.length > 0) {
        value = (null != (cache$ = cleanNull(null != dateCandidates1 && null != (cache$1 = dateCandidates1.first()) ? cache$1.attr('content') : void 0)) ? cache$.trim() : void 0) || (null != (cache$2 = cleanNull(null != dateCandidates1 && null != (cache$3 = dateCandidates1.first()) ? cache$3.attr('datetime') : void 0)) ? cache$2.trim() : void 0) || cleanText(null != dateCandidates1 && null != (cache$4 = dateCandidates1.first()) ? cache$4.text() : void 0);
        if (value)
          return value;
      }
      dateCandidates2 = doc("span[itemprop*='datePublished'],     span[property*='datePublished'],     p[itemprop*='datePublished'],     p[property*='datePublished'],     div[itemprop*='datePublished'],     div[property*='datePublished'],     li[itemprop*='datePublished'],     li[property*='datePublished'],     span[class*='date']:not([class*='update']),     span[id*='date']:not([id*='update']),     span[class*='Date'],     span[id*='Date'],     p[class*='date']:not([class*='update']),     div[class*='submitted'],     div[class='article-meta-data'] div[class='fl-right'],     div[class*='date']");
      if (dateCandidates2.length > 0) {
        value = (null != (cache$5 = cleanNull(null != dateCandidates2 && null != (cache$6 = dateCandidates2.first()) ? cache$6.attr('content') : void 0)) ? cache$5.trim() : void 0) || (null != (cache$7 = cleanNull(null != dateCandidates2 && null != (cache$8 = dateCandidates2.first()) ? cache$8.attr('datetime') : void 0)) ? cache$7.trim() : void 0) || cleanText(null != dateCandidates2 && null != (cache$9 = dateCandidates2.first()) ? cache$9.text() : void 0);
        if (value)
          return value;
      }
      patterns = [
      ...
      dateCandidates3 = doc("[class*='header'],     [id*='Info'],     [class*='Szczego'], [class*='szczego'],     [class*='intro'], [class*='meta']");
      for (var i$ = 0, length$ = dateCandidates3.length; i$ < length$; ++i$) {
        elem = dateCandidates3[i$];
        value = cleanText(doc(elem).contents().filter(function () {
          return this.type === 'text';
        }).text());
        if (value && patterns.some(function (pattern) {
      ...
      recursive = function (el) {
        var child;
        if (el.children)
          for (var i$1 = 0, length$1 = el.children.length; i$1 < length$1; ++i$1) {
      ...
      for (var i$1 = 0, length$1 = dateCandidates3.length; i$1 < length$1; ++i$1) {
        elem = dateCandidates3[i$1];
        value = recursive(elem);
        if (value)
          return value;
      }
      for (var i$2 = 0, length$2 = dateCandidates3.length; i$2 < length$2; ++i$2) {
        elem = dateCandidates3[i$2];
    ...
    image: function (doc) {
      var favicon, images, logos;
      images = doc("meta[property='og:image'],     meta[property='og:image:url'],     meta[property='og:image:secure_url'],     meta[itemprop=image],     meta[name='twitter:image:src'],     meta[name='twitter:image'],     meta[name='twitter:image0']");
      if (images.length > 0 && cleanNull(images.first().attr('content')))
        return cleanNull(images.first().attr('content'));
      logos = doc("[class*='logo'] img,     img[src*='logo']");
