...
void function () {
  ...
  module.exports = {
    date: function (doc) {
      var cache$, cache$1, cache$2, cache$3, cache$4, cache$5, cache$6, cache$7, cache$8, cache$9, content, dateCandidates1, dateCandidates2, dateCandidates3, datetime, elem, patterns, recursive, text, value;
      ...
      if (dateCandidates1.length > 0) {
        content = null != (cache$ = cleanNull(null != dateCandidates1 && null != (cache$1 = dateCandidates1.first()) ? cache$1.attr('content') : void 0)) ? cache$.trim() : void 0;
        if (content)
          return content;
        datetime = null != (cache$2 = cleanNull(null != dateCandidates1 && null != (cache$3 = dateCandidates1.first()) ? cache$3.attr('datetime') : void 0)) ? cache$2.trim() : void 0;
        text = cleanText(null != dateCandidates1 && null != (cache$4 = dateCandidates1.first()) ? cache$4.text() : void 0);
      ...
      dateCandidates2 = doc("span[itemprop*='datePublished'],     span[property*='datePublished'],     p[itemprop*='datePublished'],     p[property*='datePublished'],     div[itemprop*='datePublished'],     div[property*='datePublished'],     li[itemprop*='datePublished'],     li[property*='datePublished'],     span[class*='date']:not([class*='update']),     span[id*='date']:not([id*='update']),     span[class*='Date'],     span[id*='Date'],     [class*='info']:not([class*='information']),     p[class*='date']:not([class*='update']),     [class*='data']:not([class*='user']),     [id*='data'],     [class~='odc'],     div[class*='submitted'],     div[class='article-meta-data'] div[class='fl-right'],     div[class*='date']");
