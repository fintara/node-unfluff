...
void function () {
  ...
  module.exports = {
    date: function (doc) {
      ...
      dateCandidates2 = doc("span[itemprop*='datePublished'],     span[property*='datePublished'],     p[itemprop*='datePublished'],     p[property*='datePublished'],     div[itemprop*='datePublished'],     div[property*='datePublished'],     li[itemprop*='datePublished'],     li[property*='datePublished'],     span[class*='date']:not([class*='update']),     span[id*='date']:not([id*='update']),     span[class*='Date'],     span[id*='Date'],     [class*='info'],     p[class*='date']:not([class*='update']),     [class*='data']:not([class*='user']),     [id*='data'],     [class~='odc'],     div[class*='submitted'],     div[class='article-meta-data'] div[class='fl-right'],     div[class*='date']");
